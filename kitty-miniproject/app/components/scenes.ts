...
export const scenes = [
    ...
    // Endings
    {
      ...
      choices: [
        ...
        { text: "find way to get out of here", nextSceneId: 'scene_18' },
        { text: "face whatever is coming in here", nextSceneId: 'scene_21' },
        { text: "just wait or go back to sleep", nextSceneId: 'scene_24' }
      ]
    },
    {
      id: 'scene_15',
